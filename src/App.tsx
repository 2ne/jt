  ...
  return (
    <div className="min-h-[200vh]">
      ...
      >
        ...
        <aside
          className={`fixed inset-0 right-auto p-4 pt-[5.5rem] overflow-auto border-r shadow-lg shadow-zinc-950 border-zinc-500/10 bg-neutral-900/75 backdrop-blur-lg w-80 transition-transform duration-300 ${
            isSidebar
